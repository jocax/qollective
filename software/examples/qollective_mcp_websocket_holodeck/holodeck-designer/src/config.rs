// ABOUTME: Configuration loading system for holodeck-designer service
...
pub struct ServiceConfig {
    ...
    pub story_design: StoryDesignConfig,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct StoryDesignConfig {
    pub story_generation_timeout_ms: u64,
    pub max_story_complexity: u8,
    pub enable_character_integration: bool,
    pub canon_consistency_check: bool,
...
[story_design]
story_generation_timeout_ms = 800
...
creativity_level = 0.8
        ...
        assert_eq!(config.service.name, "holodeck-designer");
        assert_eq!(config.llm.provider, "ollama");
        assert_eq!(config.llm.model, "gemma2:2b");
        assert_eq!(config.story_design.story_generation_timeout_ms, 800);
        assert_eq!(config.story_design.creativity_level, 0.8);
    }
    ...
    fn test_llm_config_conversion() {
        let service_config = ServiceConfig {
            service: ServiceInfo {
                name: "holodeck-designer".to_string(),
            ...
            story_design: StoryDesignConfig {
                story_generation_timeout_ms: 800,
                max_story_complexity: 8,
                enable_character_integration: true,
                canon_consistency_check: true,
