// ABOUTME: Configuration loading system for holodeck-character service
...
pub struct ServiceConfig {
    ...
    pub character_ai: CharacterAiConfig,
}
...
personality_strength = 0.8
        ...
        assert_eq!(config.character_ai.response_time_target_ms, 500);
    }
    ...
    fn test_llm_config_conversion() {
        let service_config = ServiceConfig {
            ...
            character_ai: CharacterAiConfig {
                response_time_target_ms: 500,
                conversation_memory_turns: 10,
                personality_strength: 0.8,
            },
