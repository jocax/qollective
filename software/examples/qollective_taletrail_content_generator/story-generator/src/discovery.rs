//! Discovery and Health Check handlers for Story Generator service
//!
...
impl EnvelopeHandler<McpData, McpData> for DiscoveryHandler {
    fn handle(
        ...
        async move {
            ...
            let tool_registrations = StoryGeneratorHandler::get_tool_registrations();
            ...
            let discovery_data = McpDiscoveryData {
                ...
                server_info: Some(qollective::types::mcp::McpServerInfo {
                    ...
                    metadata: qollective::types::mcp::ServerMetadata {
                        description: Some(
                            "Generates branching narrative DAG structures with convergence points"
                                .to_string(),
                        ),
                        version: "0.0.1".to_string(),
                        contact: None,
                        documentation_url: None,
                        tags: vec!["story-generation".to_string(), "dag".to_string()],
                    },
                    async_config: None,
