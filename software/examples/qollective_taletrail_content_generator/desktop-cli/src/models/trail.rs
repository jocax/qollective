...
/// List item for trail directory view (CLI-specific)
...
/// Envelope wrapper for response files (CLI-specific)
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Metadata section of the envelope (CLI-specific)
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Payload section of the envelope (CLI-specific)
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct EnvelopePayload {
    pub tool_response: ToolResponse,
}

/// Tool response within the envelope (CLI-specific)
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Content item within tool response (CLI-specific)
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Trail step for linear view (simplified view of a node) - CLI-specific
#[derive(Debug, Clone, Serialize, Deserialize)]
