    ...
    <div class="flex flex-col h-full p-6">
      ...
      <div class="mb-6 space-y-4">
        ...
        <div class="flex gap-3">
          ...
          <UButton variant="solid" color="green" size="lg" to="/editor" icon="i-heroicons-plus-circle">
            Create New Story
          </UButton>
      ...
      <div class="flex-1 overflow-auto">
        ...
        <div v-if="loading" class="flex items-center justify-center p-12">
          <div class="text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400">Loading trails...</p>
          </div>
        </div>
        ...
        <div v-else-if="!directory" class="flex items-center justify-center h-full">
          <UCard class="max-w-md">
            <div class="p-8 text-center">
              ...
              <h3 class="text-lg font-semibold mb-2">No directory selected</h3>
        ...
        <div v-else-if="displayedTrails.length === 0" class="flex items-center justify-center p-12">
          <UCard class="max-w-md">
            <div class="p-8 text-center">
              ...
              <h3 class="text-lg font-semibold mb-2">No trails found</h3>
              <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
