  ...
  <UCard class="tenant-statistics">
    <template #header>
      <div class="flex items-center justify-between cursor-pointer" @click="isOpen = !isOpen">
        <div class="flex items-center gap-2">
          ...
          <h3 class="text-lg font-semibold">Tenant Statistics</h3>
    ...
    <div v-if="isOpen" class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
        <div>
          <div class="text-xs text-gray-600 dark:text-gray-400 mb-1">Total Trails</div>
          <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ totalTrails }}</div>
        </div>
        <div>
          <div class="text-xs text-gray-600 dark:text-gray-400 mb-1">Avg Success Rate</div>
          <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ averageSuccessRate }}%</div>
        </div>
      </div>
