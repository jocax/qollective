		...
		<div v-if="!isEndingNode && currentNode" class="space-y-3">
			...
			<div class="grid gap-3">
				<button
					...
					:key="choice.id"
					class="group relative p-4 rounded-lg border-2 text-left transition-all duration-200 hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-md hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" :class="[
				...
				>
					<div class="flex items-start gap-3">
						<!-- Choice Indicator -->
						<div
							class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors" :class="[
								isChoiceVisited(choice)
...
<script setup lang="ts">
	import type { Choice, ContentNode, GenerationResponse } from "~/types/trails";
