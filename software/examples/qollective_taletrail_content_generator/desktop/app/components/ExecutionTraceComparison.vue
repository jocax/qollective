...
<template>
  <div class="space-y-4">
    ...
    <UCard>
      <template #header>
        <h3 class="text-lg font-semibold">Execution Performance Comparison</h3>
      </template>

      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <!-- Total Duration -->
        <div class="space-y-1">
          <p class="text-xs text-gray-500 dark:text-gray-400">Total Duration</p>
          <div class="space-y-1">
            <p class="text-sm">
    ...
    <UCard>
      <template #header>
        <h3 class="text-lg font-semibold">Phase-by-Phase Breakdown</h3>
      </template>
      ...
      <div class="space-y-2">
        ...
        >
          ...
          <div class="grid grid-cols-2 gap-4 text-sm">
            <!-- Original -->
            <div>
              <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">Original</p>
              ...
              <p v-else class="text-xs text-gray-400">Not executed</p>
            </div>

            <!-- New -->
            <div>
              <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1">New</p>
