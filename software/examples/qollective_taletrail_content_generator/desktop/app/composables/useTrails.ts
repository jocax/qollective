...
import type { TrailListItem, GenerationResponse } from '~/types/trails'
  ...
  function loadSavedDirectory() {
    if (process.client) {
      ...
      if (saved) {
        ...
        // Auto-load default test-trails directory on first launch
        const defaultDir = '/Users/ms/development/qollective/software/examples/qollective_taletrail_content_generator/desktop/test-trails'
        loadTrails(defaultDir)
      }
    }
  }
