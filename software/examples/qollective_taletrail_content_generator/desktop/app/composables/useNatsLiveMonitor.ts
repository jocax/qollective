...
import type { GenerationEvent, GenerationRequest, PhaseProgress, NatsConnectionStatus } from '~/types/trails'
...
export function useNatsLiveMonitor() {
  ...
  function handleGenerationEvent(event: GenerationEvent) {
    ...
    // Limit events list to prevent memory issues (keep last 1000)
