//! Quality Control MCP Server Tool Handlers
//!
//! This module implements the envelope-first handler for quality control validation.
//! It provides MCP tools for validating content against age appropriateness, safety,
//! and educational value rubrics.
...
mod tests {
    ...
    async fn test_quality_control_handler_unknown_tool() {
        // ARRANGE: Create handler with default config
