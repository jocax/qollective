...
use quality_control::discovery::{DiscoveryHandler, HealthHandler};
...
async fn main() -> Result<()> {
    ...
    info!("✅ Subscribed to discovery endpoint: mcp.discovery.list_tools.quality-control");
    ...
    info!("✅ Subscribed to health endpoint: mcp.discovery.health.quality-control");
