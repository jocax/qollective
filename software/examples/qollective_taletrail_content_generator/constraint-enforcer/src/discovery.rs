//! Discovery and Health Check handlers for Constraint Enforcer service
//!
...
impl EnvelopeHandler<McpData, McpData> for DiscoveryHandler {
    fn handle(
        ...
        async move {
            ...
            let tool_registrations = ConstraintEnforcerHandler::get_tool_registrations();
            ...
            let discovery_data = McpDiscoveryData {
                ...
                server_info: Some(qollective::types::mcp::McpServerInfo {
                    ...
                    metadata: qollective::types::mcp::ServerMetadata {
                        description: Some(
                            "Enforces vocabulary, theme, and required element constraints on narrative content"
                                .to_string(),
                        ),
                        version: "0.0.1".to_string(),
                        contact: None,
                        documentation_url: None,
                        tags: vec!["constraints".to_string(), "enforcement".to_string()],
                    },
                    async_config: None,
