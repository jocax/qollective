...
mod rest_protocol_metadata_schema_tests {
    ...
    fn load_rest_protocol_schema() -> Validator {
        ...
        let schema_content = fs::read_to_string(schema_path)
            .expect("Failed to read REST protocol schema file");
    ...
    fn test_rest_protocol_schema_is_valid() {
        ...
        assert!(result.is_ok(), "REST protocol schema should be valid JSON Schema");
    }
    ...
    fn test_valid_rest_protocol_with_query_params() {
        ...
        // ASSERT: Validation should pass
        assert!(result.is_ok(), "REST protocol with query params should be valid");
    }
    ...
    fn test_invalid_rest_protocol_missing_type() {
        ...
        assert!(result.is_err(), "REST protocol without type should be invalid");
    }
    ...
    fn test_invalid_rest_protocol_wrong_type() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol with wrong type should be invalid");
    }
    ...
    fn test_invalid_rest_protocol_missing_method() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol without method should be invalid");
    }
    ...
    fn test_invalid_rest_protocol_invalid_method() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol with invalid method should be invalid");
    }
    ...
    fn test_invalid_rest_protocol_missing_uri_path() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol without uri_path should be invalid");
    }
    ...
    fn test_invalid_rest_protocol_empty_uri_path() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol with empty uri_path should be invalid");
    }
    ...
    fn test_invalid_rest_protocol_uri_path_no_slash() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol with uri_path not starting with / should be invalid");
    }
    ...
    fn test_invalid_rest_protocol_query_params_not_string() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol with non-string query param values should be invalid");
    }
    ...
    fn test_invalid_rest_protocol_headers_not_string() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol with non-string header values should be invalid");
    }
    ...
    fn test_rest_protocol_no_additional_properties() {
        ...
        // ASSERT: Validation should fail
        assert!(result.is_err(), "REST protocol with additional properties should be invalid");
    }
    ...
    fn test_json_serialization_roundtrip() {
        ...
        assert!(validation_result.is_ok(), "JSON object should be valid against schema");
        ...
        assert_eq!(obj.get("uri_path").unwrap().as_str().unwrap(), "/api/v1/users");
        ...
        assert_eq!(headers.get("content-type").unwrap().as_str().unwrap(), "application/json");
    ...
    fn test_uri_path_length_limits() {
        ...
        let result = validator.validate(&invalid_protocol);
        assert!(result.is_err(), "URI path over maximum length should be invalid");
    }
}