...
mod schema_validation_tests {
    ...
    fn test_envelope_schema_is_valid() {
        ...
        assert!(
            result.is_ok(),
            "Envelope schema should be valid JSON Schema"
        );
    }
    ...
    fn test_envelope_schema_rejects_both_data_and_error() {
        ...
        assert!(
            ...
            "Response with both data and error should fail validation"
        );
    }
    ...
    fn test_envelope_schema_rejects_neither_data_nor_error() {
        ...
        assert!(
            validation_result.is_err(),
            "Response with neither data nor error should fail validation"
        );
    }
    ...
    fn test_envelope_schema_validates_required_meta_fields() {
        ...
        assert!(
            validation_result.is_err(),
            "Response missing required meta fields should fail validation"
        );
    }
    ...
    fn test_envelope_schema_validates_timestamp_format() {
        ...
        assert!(
            validation_result.is_err(),
            "Response with invalid timestamp format should fail validation"
        );
    }
    ...
    fn test_envelope_schema_validates_uuid_format() {
        ...
        assert!(
            validation_result.is_err(),
            "Response with invalid UUID format should fail validation"
        );
    }
    ...
    fn test_envelope_schema_validates_version_format() {
        ...
        assert!(
            validation_result.is_err(),
            "Response with invalid version format should fail validation"
        );
    }
    ...
    fn test_envelope_schema_validates_service_chain() {
        ...
        assert!(
            validation_result.is_ok(),
            "Response with valid service chain should pass validation"
        );
    }
    ...
    fn test_envelope_schema_validates_optional_meta_sections() {
        ...
        assert!(
            validation_result.is_ok(),
            "Response with all optional meta sections should pass validation"
        );
    }
    ...
    fn test_envelope_schema_validates_extensions() {
        ...
        assert!(
            validation_result.is_ok(),
            "Response with valid extensions should pass validation"
        );
    }
