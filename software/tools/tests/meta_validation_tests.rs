...
mod meta_validation_tests {
    ...
    fn test_security_meta_schema_is_valid() {
        ...
        assert!(
            result.is_ok(),
            "Security meta schema should be valid JSON Schema"
        );
    }
    ...
    fn test_performance_meta_schema_is_valid() {
        ...
        let schema_content =
            fs::read_to_string(schema_path).expect("Failed to read performance meta schema file");
        ...
        assert!(
            result.is_ok(),
            "Performance meta schema should be valid JSON Schema"
        );
    }
    ...
    fn test_tracing_meta_schema_is_valid() {
        ...
        let schema_content =
            fs::read_to_string(schema_path).expect("Failed to read tracing meta schema file");
        ...
        assert!(
            result.is_ok(),
            "Tracing meta schema should be valid JSON Schema"
        );
    }
    ...
    fn test_debug_meta_schema_is_valid() {
        ...
        let schema_content =
            fs::read_to_string(schema_path).expect("Failed to read debug meta schema file");
        ...
        assert!(
            result.is_ok(),
            "Debug meta schema should be valid JSON Schema"
        );
    }
    ...
    fn test_monitoring_meta_schema_is_valid() {
        ...
        let schema_content =
            fs::read_to_string(schema_path).expect("Failed to read monitoring meta schema file");
        ...
        assert!(
            result.is_ok(),
            "Monitoring meta schema should be valid JSON Schema"
        );
    }
    ...
    fn test_security_meta_validates_complete_example() {
        ...
        assert!(
            ...
            "Valid security meta should pass validation"
        );
    }
    ...
    fn test_security_meta_validates_geo_location() {
        ...
        assert!(
            validation_result.is_ok(),
            "Meta with geo location should pass validation"
        );
    }
    ...
    fn test_security_meta_validates_compliance_flags() {
        ...
        for (compliance_flags, should_be_valid) in test_cases {
            ...
            if should_be_valid {
                assert!(
                    validation_result.is_ok(),
                    "Compliance flags {:?} should be valid",
                    compliance_flags
                );
            } else {
                assert!(
                    validation_result.is_err(),
                    "Compliance flags {:?} should be invalid",
                    compliance_flags
                );
            }
        }
    ...
    fn test_security_meta_allows_minimal_data() {
        ...
        assert!(
            validation_result.is_ok(),
            "Minimal security meta should pass validation"
        );
    }
    ...
    fn test_security_meta_rejects_additional_properties() {
        ...
        assert!(
            validation_result.is_err(),
            "Security meta with additional properties should fail validation"
        );
    }
