...
mod service_config_validation_tests {
    ...
    fn test_service_config_schema_is_valid() {
        ...
        assert!(
            result.is_ok(),
            "Service config schema should be valid JSON Schema"
        );
    }
    ...
    fn test_minimal_service_config_validates() {
        ...
        assert!(
            ...
            "Minimal service config should pass validation"
        );
    }
    ...
    fn test_complete_service_config_validates() {
        ...
        assert!(
            validation_result.is_ok(),
            "Complete service config should pass validation"
        );
    }
    ...
    fn test_meta_section_config_validation() {
        ...
        assert!(
            validation_result.is_ok(),
            "Config with meta sections should pass validation"
        );
    }
    ...
    fn test_sampling_rate_validation() {
        ...
        for (sampling_rate, should_be_valid) in test_cases {
            ...
            if should_be_valid {
                ...
                assert!(
                    validation_result.is_err(),
                    "Sampling rate {} should be invalid",
                    sampling_rate
                );
            }
        }
    ...
    fn test_protocol_configuration_validation() {
        ...
        assert!(
            validation_result.is_ok(),
            "Config with protocol settings should pass validation"
        );
    }
    ...
    fn test_presets_configuration_validation() {
        ...
        assert!(
            validation_result.is_ok(),
            "Config with presets should pass validation"
        );
    }
    ...
    fn test_environments_configuration_validation() {
        ...
        assert!(
            validation_result.is_ok(),
            "Config with environments should pass validation"
        );
    }
    ...
    fn test_contact_information_validation() {
        ...
        assert!(
            validation_result.is_ok(),
            "Config with contact info should pass validation"
        );
    }
    ...
    fn test_invalid_email_format() {
        ...
        assert!(
            validation_result.is_err(),
            "Config with invalid email should fail validation"
        );
    }
    ...
    fn test_missing_required_fields() {
        ...
        assert!(
            schema.validate(&config_missing_name).is_err(),
            "Config missing service name should fail"
        );
        assert!(
            schema.validate(&config_missing_version).is_err(),
            "Config missing service version should fail"
        );
        assert!(
            schema.validate(&config_missing_qollective).is_err(),
            "Config missing qollective section should fail"
        );
    }
